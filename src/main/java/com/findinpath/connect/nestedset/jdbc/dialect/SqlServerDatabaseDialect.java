...
public class SqlServerDatabaseDialect extends GenericDatabaseDialect {
    ...
    @Override
    public List<String> buildCreateLogTableStatements(TableId table, String primaryKeyColumnName, String operationTypeColumnName, Collection<SinkRecordField> fields) {
        ExpressionBuilder builder = expressionBuilder();
        ...
        builder.append(" ");
        builder.append("BIGINT NOT NULL IDENTITY(1,1),");
